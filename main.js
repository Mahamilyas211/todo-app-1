window.addEventListener('load', () => {
    ...
    function updateDateInfo() {
        ...
        currentDateElement.textContent = currentDate.toLocaleDateString(undefined, { day: 'numeric', month: 'long' });
        currentDayElement.textContent = currentDate.toLocaleDateString(undefined, { weekday: 'long' });
        currentYearElement.textContent = currentDate.toLocaleDateString(undefined, { year: 'numeric' });
    }
